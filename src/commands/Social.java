...
public class Social {
	public static enum Targets {
		...
		TARGET, 
		PEERS};
	private static TreeMap<String, Social> listSociales;
	...
	public static void setList(TreeMap<String, Social> sociales) {
		listSociales = sociales;
	}
	
	public static Iterator<String> getList() {
		return listSociales.keySet().iterator();
	}
	
	public static Social getSocial(String nombre) {
		String key = listSociales.ceilingKey(nombre);
		if (key.startsWith(nombre)) return listSociales.get(key);
